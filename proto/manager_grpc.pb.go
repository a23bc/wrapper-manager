...
type WrapperManagerServiceClient interface {
	...
	Login(ctx context.Context, opts ...grpc.CallOption) (WrapperManagerService_LoginClient, error)
	Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutReply, error)
	Decrypt(ctx context.Context, opts ...grpc.CallOption) (WrapperManagerService_DecryptClient, error)
...
func (c *wrapperManagerServiceClient) Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StatusReply, error) {
	out := new(StatusReply)
	err := c.cc.Invoke(ctx, WrapperManagerService_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperManagerServiceClient) Login(ctx context.Context, opts ...grpc.CallOption) (WrapperManagerService_LoginClient, error) {
	stream, err := c.cc.NewStream(ctx, &WrapperManagerService_ServiceDesc.Streams[0], WrapperManagerService_Login_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &wrapperManagerServiceLoginClient{stream}
	return x, nil
}

type WrapperManagerService_LoginClient interface {
	Send(*LoginRequest) error
	Recv() (*LoginReply, error)
	grpc.ClientStream
}

type wrapperManagerServiceLoginClient struct {
	grpc.ClientStream
}

func (x *wrapperManagerServiceLoginClient) Send(m *LoginRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *wrapperManagerServiceLoginClient) Recv() (*LoginReply, error) {
	m := new(LoginReply)
...
func (c *wrapperManagerServiceClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutReply, error) {
	out := new(LogoutReply)
	err := c.cc.Invoke(ctx, WrapperManagerService_Logout_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperManagerServiceClient) Decrypt(ctx context.Context, opts ...grpc.CallOption) (WrapperManagerService_DecryptClient, error) {
	stream, err := c.cc.NewStream(ctx, &WrapperManagerService_ServiceDesc.Streams[1], WrapperManagerService_Decrypt_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &wrapperManagerServiceDecryptClient{stream}
	return x, nil
}

type WrapperManagerService_DecryptClient interface {
	Send(*DecryptRequest) error
	Recv() (*DecryptReply, error)
	grpc.ClientStream
}

type wrapperManagerServiceDecryptClient struct {
	grpc.ClientStream
}

func (x *wrapperManagerServiceDecryptClient) Send(m *DecryptRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *wrapperManagerServiceDecryptClient) Recv() (*DecryptReply, error) {
	m := new(DecryptReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *wrapperManagerServiceClient) M3U8(ctx context.Context, in *M3U8Request, opts ...grpc.CallOption) (*M3U8Reply, error) {
	out := new(M3U8Reply)
	err := c.cc.Invoke(ctx, WrapperManagerService_M3U8_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperManagerServiceClient) Lyrics(ctx context.Context, in *LyricsRequest, opts ...grpc.CallOption) (*LyricsReply, error) {
	out := new(LyricsReply)
	err := c.cc.Invoke(ctx, WrapperManagerService_Lyrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperManagerServiceClient) License(ctx context.Context, in *LicenseRequest, opts ...grpc.CallOption) (*LicenseReply, error) {
	...
	err := c.cc.Invoke(ctx, WrapperManagerService_License_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperManagerServiceClient) WebPlayback(ctx context.Context, in *WebPlaybackRequest, opts ...grpc.CallOption) (*WebPlaybackReply, error) {
	...
	err := c.cc.Invoke(ctx, WrapperManagerService_WebPlayback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WrapperManagerServiceServer interface {
	...
	Login(WrapperManagerService_LoginServer) error
	Logout(context.Context, *LogoutRequest) (*LogoutReply, error)
	Decrypt(WrapperManagerService_DecryptServer) error
...
// UnimplementedWrapperManagerServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedWrapperManagerServiceServer) Login(WrapperManagerService_LoginServer) error {
...
func (UnimplementedWrapperManagerServiceServer) Decrypt(WrapperManagerService_DecryptServer) error {
...
func _WrapperManagerService_Login_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WrapperManagerServiceServer).Login(&wrapperManagerServiceLoginServer{stream})
}

type WrapperManagerService_LoginServer interface {
	Send(*LoginReply) error
	Recv() (*LoginRequest, error)
	grpc.ServerStream
}

type wrapperManagerServiceLoginServer struct {
	grpc.ServerStream
}

func (x *wrapperManagerServiceLoginServer) Send(m *LoginReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *wrapperManagerServiceLoginServer) Recv() (*LoginRequest, error) {
	m := new(LoginRequest)
...
func _WrapperManagerService_Decrypt_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(WrapperManagerServiceServer).Decrypt(&wrapperManagerServiceDecryptServer{stream})
}

type WrapperManagerService_DecryptServer interface {
	Send(*DecryptReply) error
	Recv() (*DecryptRequest, error)
	grpc.ServerStream
}

type wrapperManagerServiceDecryptServer struct {
	grpc.ServerStream
}

func (x *wrapperManagerServiceDecryptServer) Send(m *DecryptReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *wrapperManagerServiceDecryptServer) Recv() (*DecryptRequest, error) {
